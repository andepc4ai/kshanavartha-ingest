...
CINEMA_MAX = int(os.environ.get("CINEMA_MAX") or "15")
...
# Hook-first Telugu summary. Lead with the most surprising/impactful fact so
# the reader is hooked in the first sentence. CATEGORY and LEVEL are handled
# entirely by our own classifiers — not asked from the AI (saves tokens).
SUMMARY_PROMPT = (
    "మీరు అనుభవజ్ఞుడైన తెలుగు వార్తా సంపాదకులు. పాఠకుడిని మొదటి వాక్యంలోనే "
    "ఆకట్టుకునే విధంగా రాయండి — అత్యంత ముఖ్యమైన లేదా ఆశ్చర్యకరమైన విషయంతో "
    "ప్రారంభించండి. ఇంగ్లీష్ వార్తనైతే సహజమైన తెలుగులోకి అనువదించండి; "
    ...
    "మూలం చిట్కా/టిప్స్/ఎలా చేయాలో చెప్పే కథనం అయితే, 'కొన్ని చిట్కాలు ఉన్నాయి' అని మాత్రమే "
    "చెప్పి ఆగవద్దు — అసలు పద్ధతి/టెక్నిక్ ఏమిటో (ఉదా: ఏ వస్తువు వాడాలి, ఎలా చేయాలి) ఖచ్చితంగా "
    "పేర్కొనాలి. పరిచయ వాక్యాలను పునరావృతం చేస్తూ అసలు సమాధానాన్ని వదిలేయవద్దు. "
